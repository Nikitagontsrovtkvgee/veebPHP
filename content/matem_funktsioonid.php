...
$arv3 = 42; 
// Доделал начатое тобой задание:
echo "Arva ära minu mõeldud arv!";
?>
<form method="post">
    <input type="number" name="user_arv" placeholder="Sisesta arv">
    <input type="submit" value="Kontrolli">
</form>
<?php
if(isset($_POST["user_arv"])){
    if($_POST["user_arv"] == $arv3){
        echo "Õige! Arv oli " . $arv3;
    } else {
